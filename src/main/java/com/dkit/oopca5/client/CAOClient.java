...
public class CAOClient
{
    ...
    private void displayCurrentChoices(int caoNumber)
    {
        ...
        System.out.println("Client Request: " + msgForServer);
            ...
            if(response.startsWith(CAOService.SUCCESSFUL_DISPLAY_CURRENT)){
                System.out.println(Colours.GREEN + response + Colours.RESET);
            }
            else {
                System.out.println(Colours.RED + response + Colours.RESET);
    ...
    private void logout()
    {
        ...
        System.out.println("Client Request: " + msgForServer);
            ...
            if(response.equals(CAOService.SUCCESSFUL_LOGOUT)){
                System.out.println(Colours.GREEN + "Successfully logged out" + Colours.RESET);
            }
            out.close();
            inStream.close();
            socket.close();
